  ...
  return (
    <main className="min-h-screen bg-[#141414] text-white overflow-x-hidden">
              ...
              >
                {plan.highlighted && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="bg-[#E50914] text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest whitespace-nowrap">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                >
                  <Link
                    href="/login"
                    className={`block w-full text-center font-bold py-3.5 rounded-xl text-sm transition-all duration-200 ${
                      plan.highlighted
                        ? "bg-[#E50914] text-white hover:bg-[#c8070f] shadow-lg shadow-[#E50914]/30"
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Loved by{" "}
              <span className="text-[#E50914]">250 million</span> viewers
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-[#B3B3B3] text-lg">
              Join the world's most passionate streaming community.
            </motion.p>
          </motion.div>
          ...
          >
            {TESTIMONIALS.map((t, i) => (
              <motion.div
                ...
                className={`bg-[#1a1a1a] border rounded-2xl p-7 transition-all duration-300 cursor-default ${
                  activeTestimonial === i
                    ? "border-[#E50914]/40"
                    : "border-white/8"
                }`}
              ...
              >
                ...
                <p className="text-[#E8E8E8] text-sm leading-relaxed mb-6 italic">
                  &ldquo;{t.text}&rdquo;
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#B3B3B3] text-xs">{t.location}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#E50914]/20 via-[#141414] to-[#0080FF]/10" />
        <div className="absolute inset-0">
        ...
        <div className="relative z-10 max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              Ready to watch?
              <br />
              <span className="text-[#E50914]">Start streaming today.</span>
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-[#B3B3B3] text-lg mb-10 max-w-xl mx-auto"
            >
              Enter your email to create or restart your membership. Cancel
            ...
            <motion.div variants={fadeInUp} className="max-w-lg mx-auto">
              {emailSubmitted ? (
                <motion.div
                  ...
                  className="flex items-center justify-center gap-3 bg-[#1a1a1a] border border-green-500/40 rounded-2xl px-8 py-5"
                >
                  <div className="w-8 h-8 bg-green-500/20 rounded-full flex items-center justify-center">
                    <Check size={16} className="text-green-400" />
                  </div>
                  <p className="text-white font-semibold">
                    Great! Check your email to get started.
                  </p>
                </motion.div>
              ) : (
                <form
                ...
                >
                  <input
                    ...
                    required
                    className="flex-1 bg-[#1a1a1a] border border-white/20 text-white placeholder-[#666] rounded-xl px-5 py-4 text-sm focus:outline-none focus:border-[#E50914]/60 focus:ring-2 focus:ring-[#E50914]/20 transition-all"
                  />
                  <motion.button
                    type="submit"
                    whileHover={shouldReduceMotion ? {} : { scale: 1.04 }}
                    whileTap={shouldReduceMotion ? {} : { scale: 0.97 }}
                    className="bg-[#E50914] text-white font-bold px-8 py-4 rounded-xl text-sm hover:bg-[#c8070f] transition-colors shadow-lg shadow-[#E50914]/30 flex items-center justify-center gap-2 whitespace-nowrap"
                  >
                    Get Started
                    <ArrowRight size={16} />
                  </motion.button>
            ...
            <motion.p
              variants={fadeInUp}
              className="text-[#666] text-xs mt-5"
            >
              By signing up, you agree to our{" "}
              <Link href="/terms" className="text-[#B3B3B3] hover:text-white underline transition-colors">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-[#B3B3B3] hover:text-white underline transition-colors">
                Privacy Policy
              </Link>
              .
            </motion.p>
